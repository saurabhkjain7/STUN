...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, image_list, transform=None, target_transform=None, return_paths=False,
                 loader=default_loader,train=False, return_id=False, strong = False):
    ...
    def __getitem__(self, index):
        ...
        if self.return_paths:
            if self.strong:
                ...
                img_bar  = transform_strong(img_orig)
                return img,img_bar,target,path
            else:
            ...
            if self.strong:
                transform_strong = strong_transform()
                img_bar  = transform_strong(img_orig)
                return img,img_bar,target,index 
            else: 
